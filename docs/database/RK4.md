...
Для этого нужно выполнить миграции, а также заполнение базы тестовыми данными:
...
```bash
# Запрос рекомендаций фильмов с нагрузкой 50 запросов в секунду в течение 30 секунд
