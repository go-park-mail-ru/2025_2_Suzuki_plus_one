...
Посмотрев на полученные [отчет](../../scripts/vegeta/reports/post_auth_signup_users_100000_20251219_233058_hist.txt) после попытки создать 100000 пользователей на 200 RPS, можно сделать выводы о плохой производительности системы при высоких нагрузках.
