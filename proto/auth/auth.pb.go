...
const file_proto_auth_auth_proto_rawDesc = "" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12!\n" +
	"\faccess_token\x18\x02 \x01(\tR\vaccessToken2\x84\x02\n" +
	"\vAuthService\x12A\n" +
	"\n" +
	"CreateUser\x12\x17.auth.CreateUserRequest\x1a\x18.auth.CreateUserResponse\"\x00\x122\n" +
	...
	"\fRefreshToken\x12\x19.auth.RefreshTokenRequest\x1a\x1a.auth.RefreshTokenResponse\"\x00BEZCgithub.com/go-park-mail-ru/2025_2_Suzuki_plus_one/proto/auth;authpbb\x06proto3"
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	1, // 4: auth.AuthService.CreateUser:output_type -> auth.CreateUserResponse
